...
%>
	...
	<div class="header">
		...
		<div class="header-center">
			<a class="active">Editing ${Professor.name} ${Professor.surname}</a>
		</div>
	  	<div class="header-right">
	    	<a href="${pageContext.request.contextPath}/secretaryPages/profile.jsp"><%=session.getAttribute("username") %></a>
	 	</div>
	</div>
	<h2>Edit Professor P${Professor.registrationNumber}</h2>
	<div class="container">
		<form method="POST" action='ProfessorController' name="frmeditProfessor">
			...
			<div class="row">
				<div class="col-25">
		      	...
		      	<div class="col-75">
					<input type="number" name="afmnumber" value="<c:out value="${Professor.afmNumber}" />" min="100000000" max="999999999" required>
			  	</div>
			</div>
			<div class="row">
			  <div class="col-25">
		      ...
		      <div class="col-75">
			  		<input type="text" name="name" value="<c:out value="${Professor.name}" />" pattern="[a-zA-Z]{2,}" required>
			  </div>		
			</div>
			<div class="row">
			  <div class="col-25">
		      ...
		      <div class="col-75">	
					<input type="text" name="surname" value="<c:out value="${Professor.surname}" />" pattern="[a-zA-Z]{2,}" required>
			  </div>
			</div>
			<div class="row">
			  <div class="col-25">
		      ...
		      <div class="col-75">
				<input type="number" name="acadyearadmission" value="<c:out value="${Professor.acadYearAdmission}" />" min="1991" max="2022" required>
			  </div>
			</div>
			<div class="row">
			  <div class="col-25">
		      ...
		      <div class="col-75">
				 <input type="date" name="birthdate" value="<c:out value="${Professor.birthDate}" />" min="1950-01-01" max="2003-12-31" required>
		      </div>
		    </div>
			<div class="row">
			  <div class="col-25">
		      ...
		      <div class="col-75">
				<input type="text" name="email" value="<c:out value="${Professor.email}" />" required>
			  </div>
			</div>
			<div class="row">
		      <br>
