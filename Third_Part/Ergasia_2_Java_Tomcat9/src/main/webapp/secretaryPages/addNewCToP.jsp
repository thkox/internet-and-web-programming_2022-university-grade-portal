			...
			<table class="content-table">
				...
				<tbody>
					<tr>
						...
						<td>
							<select name="professors" id="professors" required>
								<c:forEach items="${requestScope.Professors}" var="s">
									<option value="<c:out value="${s.registrationNumber}" />">P${s.registrationNumber} ${s.surname}</option>
								</c:forEach>
							</select>
						</td>
					</tr>
						...
						<td>
							<select name="courses" id="courses" required>
								<c:forEach items="${requestScope.Courses}" var="c">
									<option value="<c:out value="${c.idcourse}"/>">${c.idcourse} ${c.title}</option>
								</c:forEach>
							</select>
						</td>
					</tr>
