	...
	<div id="main">
		<div class="header">
			...
			<div class="header-center">
				<a class="active" >View Courses</a>
				<a href="${pageContext.request.contextPath}/CourseController?action=insert">Add Courses</a>
			</div>
		  	<div class="header-right">
		    	<a href="${pageContext.request.contextPath}/secretaryPages/profile.jsp"><%=session.getAttribute("username") %></a>
		 	</div>
		</div>
		<h2>Course's Table</h2>
	        ...
	        <tbody>
           	<c:forEach items="${requestScope.Courses}" var="s">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/CourseController?action=edit&IdCourse=<c:out value="${s.idcourse }"/>">Edit</a></td>
                    <td><a href="${pageContext.request.contextPath}/CourseController?action=delete&IdCourse=<c:out value="${s.idcourse }"/>">Delete</a></td>
                </tr>
            </c:forEach>
            </tbody>
	     </table>
