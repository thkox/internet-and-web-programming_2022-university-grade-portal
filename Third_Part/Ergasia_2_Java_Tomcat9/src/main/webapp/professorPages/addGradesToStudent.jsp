...
<head>
<meta charset="UTF-8">
	<title>Add F${Grade.student.registrationNumber}'s Grades</title>
	...
	<div id="main">
		...
		<div class="header">
			...
			<div class="header-center">
				<a href="${pageContext.request.contextPath}/professorPages/gradesList.jsp">Grades List for each Course</a>
				<a class="active">Assign Grades to Course: <c:out value="${Grade.course.title}"/></a>
			</div>
		...
		<form method="POST" action='ProfessorController' name="frmeditGradeStudent">
			...
			<div class="row">
		    	<div class="col-25">
		      	...
		      	<div class="col-75">
					<input type="number" name="exerGrade" value="<c:out value="${Grade.course.exerGrade}" />" placeholder="Enter Exercise Grade"  min="0" max="10" required>
				</div>
			</div>			
			<div class="row">
		    	<div class="col-25">
		      	...
		      	<div class="col-75">
					<input type="number" name="examGrade" value="<c:out value="${Grade.course.examGrade}" />" placeholder="Enter Examination Grade"  min="0" max="10" required>
				</div>
			</div>			
			<div class="row">
		    	<div class="col-25">
		      	...
		      	<div class="col-75">
					<input type="number" name="finalGrade" value="<c:out value="${Grade.course.finalGrade}" />" placeholder="Enter Final Course Grade"  min="0" max="10" required>
				</div>
			</div>
			<div class="row">
		      <br>
