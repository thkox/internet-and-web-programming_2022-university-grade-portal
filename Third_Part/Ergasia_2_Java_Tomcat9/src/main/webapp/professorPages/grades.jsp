...
<body>
	...
	<div id="main">
		...
		<br>
	 	<div class="container">
	 		<div class="center">
	 			<a href="${pageContext.request.contextPath}/CourseController?action=selectCourseView&registNumber=<%=session.getAttribute("username") %>">
	 				<button id="gradesList" class="btn">Grades List Per Course</button>
	 			</a>
	 			<br>
	 			<a href="${pageContext.request.contextPath}/CourseController?action=selectCourseAssign&registNumber=<%=session.getAttribute("username") %>">
	 				<button id="assignGrades" class="btn">Assign Grades Per Course</button>
	 			</a>
	 			<br>
	 		</div>
	 	</div>
