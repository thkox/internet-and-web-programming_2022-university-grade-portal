	...
	<div id="main">
		<div class="header">
			...
			<div class="header-center">
				<a class="active">All your Grades</a>
				<a href="${pageContext.request.contextPath}/StudentController?action=selectSemester&registNumber=<%=session.getAttribute("username") %>">Grades Per Semester</a>
			</div>
		...
		<table  class="content-table">
	        ...
	        <% int totalsum = 0; int count=0; %>
	           	<c:forEach items="${requestScope.Grades}" var="s">
	                <tr>
