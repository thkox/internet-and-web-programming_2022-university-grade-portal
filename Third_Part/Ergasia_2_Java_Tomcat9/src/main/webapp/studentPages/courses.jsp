...
<body>
	...
	<div id="main">
		...
		<div class="container">
		  <div class="center">
			<a href="${pageContext.request.contextPath}/StudentController?action=viewCourses&registNumber=<%=session.getAttribute("username") %>"> <!-- /StudentController?action=listCourse -->
				<button id="registerStudent" class="btn">All Your Assigned Courses</button>
			</a>
			<br>
			<a href="${pageContext.request.contextPath}/StudentController?action=assignCourse&registNumber=<%=session.getAttribute("username") %>"> <!-- /StudentController?action=assignNewCourse -->
				<button class="btn">Assign A New Course</button>
			</a>
		  </div>
		</div>
	</div>
