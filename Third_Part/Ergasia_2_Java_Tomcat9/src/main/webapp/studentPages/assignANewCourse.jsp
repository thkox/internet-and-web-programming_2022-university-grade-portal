...
<head>
	<meta charset="utf-8">
	<title>Assign A New Course</title>
	...
	<div id="main">
		<div class="header">
			...
			<div class="header-center">
				<a href="${pageContext.request.contextPath}/StudentController?action=viewCourses&registNumber=<%=session.getAttribute("username") %>">All Your Assigned Courses</a>
		...
		<form method="GET" action="StudentController" name="frmselectSemester">
			<input type="hidden" name="action" value="selectedCourse" />
			...
			<table class="content-table">
				...
				<tbody>
					<tr>
						<td>
							<label for="courses">Select a course that you want: </label>
						</td>
						<td>
