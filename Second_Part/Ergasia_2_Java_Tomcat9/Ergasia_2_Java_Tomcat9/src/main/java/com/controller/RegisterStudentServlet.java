...
public class RegisterStudentServlet extends HttpServlet {
    ...
    //activates only when we want to create a new student account
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Student student;
		String salt = accountdb.getAlphaNumericString(16);	//we create a random salt with the length of 16 characters
		...
		if (registNumbervalidation == true)
		{
			...
			try {
				...
				//to change-> after finished the sign up redirect to log in page
