	...
	<form method="POST" action='StudentController' name="frmeditProfessor">
		...
		<div class="row">
	    	<div class="col-25">
	      	...
	      	<div class="col-75">
				<input type="number" name="acadyearadmission" value="<c:out value="${Student.acadYearAdmission}" />" />
			</div>
		</div>			
		<div class="row">
	    	<div class="col-25">
	      	...
	      	<div class="col-75">
				<input type="date" name="birthdate" value="<c:out value="${Student.birthDate}" />" />
			</div>
		</div>			
		<div class="row">
	    	<div class="col-25">
		...
		<div class="row">
	    	<div class="col-25">
	      	...
	      	<div class="col-75">
				<input type="number" name="semester" value="<c:out value="${Student.semester}" />" />
			</div>
		</div>			
		<div class="row">
	      <br>
