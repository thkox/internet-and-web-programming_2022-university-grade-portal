	...
	<div id="main">
		<div class="header">
			...
			<div class="header-center">
				<a href="${pageContext.request.contextPath}/CoursesController?action=listCourse">View Courses</a>
		...
		<h2>Add a course</h2>
		<form method="POST" action='CoursesController' name="frmAddCourse">
		
			<input type="hidden" name="action" value="insert" />
		
			<div class="row">
		      <div class="col-25">
		        <label for="idcourses">ID Course</label>
		      </div>
		      <div class="col-75">
